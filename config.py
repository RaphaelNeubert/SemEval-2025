...
class Config:
    ...
    load_weights_from: str = "./weights/weights-pre-fine-23000.pth"
    ...
    finetune_config = TrainingConfig(
        ...
        save_weights = True,
        save_weights_to = "./weights/weights-pre-fine2-<training_step>.pth", # <training_step> placeholder will be replaced
    )
    pretraining_config = TrainingConfig(
        ...
        unfreeze_count = 2 #model_config.num_encoder_layers
    )
